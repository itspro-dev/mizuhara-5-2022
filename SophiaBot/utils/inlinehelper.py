...
from chizuru_mizuharaBot import BOT_USERNAME, OWNER_ID, pbot, arq
from chizuru_mizuharaBot.pyrogramee.pluginshelper import convert_seconds_to_minutes as time_convert
from chizuru_mizuharaBot.pyrogramee.pluginshelper import fetch
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/chizuru_mizuhara_robot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[chizuru_mizuhara](https://github.com/dihanofficial/chizuru_mizuharaBot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
