...
from chizuru_mizuharaBot.__main__ import STATS, TOKEN, USER_INFO
import chizuru_mizuharaBot.modules.sql.userinfo_sql as sql
from chizuru_mizuharaBot.modules.disable import DisableAbleCommandHandler
from chizuru_mizuharaBot.modules.sql.global_bans_sql import is_user_gbanned
from chizuru_mizuharaBot.modules.sql.afk_sql import is_afk, check_afk_status
from chizuru_mizuharaBot.modules.sql.users_sql import get_user_num_chats
from chizuru_mizuharaBot.modules.helper_funcs.chat_status import sudo_plus
from chizuru_mizuharaBot.modules.helper_funcs.extraction import extract_user
from chizuru_mizuharaBot import telethn as YoneTelethonClient, TIGERS, DRAGONS, DEMONS
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>📊 chizuru_mizuhara's Current stats:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
