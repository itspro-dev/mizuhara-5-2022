...
import chizuru_mizuharaBot.modules.sql.notes_sql as sql
from chizuru_mizuharaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from chizuru_mizuharaBot.__main__ import DATA_IMPORT
from chizuru_mizuharaBot.modules.helper_funcs.chat_status import user_admin
from chizuru_mizuharaBot.modules.helper_funcs.alternate import typing_action

# from chizuru_mizuharaBot.modules.rules import get_rules
import chizuru_mizuharaBot.modules.sql.rules_sql as rulessql

# from chizuru_mizuharaBot.modules.sql import warns_sql as warnssql
import chizuru_mizuharaBot.modules.sql.blacklist_sql as blacklistsql
from chizuru_mizuharaBot.modules.sql import disable_sql as disabledsql

# from chizuru_mizuharaBot.modules.sql import cust_filters_sql as filtersql
# import chizuru_mizuharaBot.modules.sql.welcome_sql as welcsql
import chizuru_mizuharaBot.modules.sql.locks_sql as locksql
from chizuru_mizuharaBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("chizuru_mizuharaBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("chizuru_mizuharaBot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `chizuru_mizuhara-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("chizuru_mizuharaBot{}.backup".format(chat_id))  # Cleaning file
