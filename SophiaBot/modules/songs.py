...
from chizuru_mizuharaBot import pbot as Dihan
from chizuru_mizuharaBot.pyrogramee.dark import get_arg
...
import aiohttp
from pyrogram import filters
from chizuru_mizuharaBot import pbot as chizuru_mizuhara
...
async def download_song(url):
    song_name = f"chizuru_mizuhara.mp3"
    async with aiohttp.ClientSession() as session:
        async with session.get(url) as resp:
            if resp.status == 200:
...
@chizuru_mizuhara.on_message(filters.command("deezer"))
...
import aiohttp
from pyrogram import filters
from chizuru_mizuharaBot import pbot as CHABEE
